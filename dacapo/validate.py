...
def validate_run_using_datasplit(
    run: Run,
    iteration: int,
    datasplit: DataSplit,
    num_workers: int = 5,
    ...
    try:  # we don't want this to hold up training
        ...
        if (
            datasplit.validate is None
            or len(datasplit.validate) == 0
            or datasplit.validate[0].gt is None
        ):
