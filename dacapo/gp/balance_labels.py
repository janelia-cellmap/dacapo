...
class BalanceLabelBoundaries(BatchFilter):
    '''Creates a scale array to balance the loss between class labels.
    Treats the boundary of labeled volumes as seperate labels to the interior.
    Must be given a radius with which to consider a voxel part of a volumes
    boundary region.
    ...
    Args:
        ...
        boundary_radius (``float``, optional):
            ...
            the radius with which to consider boundaries of volumes as seperate
            labels.

    '''

    def __init__(self, labels, scales, mask=None, slab=None, num_classes=2,
                 clipmin=0.05, clipmax=0.95, boundary_radius=0):
