...
from .CycleGAN_post_processor_parameters import CycleGANPostProcessorParameters
...
class CycleGANPostProcessor(PostProcessor):
    def __init__(self) -> None:
        super().__init__()

    def enumerate_parameters(self) -> Iterable[CycleGANPostProcessorParameters]:
        """Enumerate all possible parameters of this post-processor."""

        yield CycleGANPostProcessorParameters(id=1)
