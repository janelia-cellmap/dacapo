"""
This module provides a configuration class for dummy datasets in the daCapo python library.

Classes:
    DummyDatasetConfig: A config class for dummy datasets used for testing.
"""
